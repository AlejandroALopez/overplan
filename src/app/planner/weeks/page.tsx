...
import back from "../../../../public/arrows/back.svg";
        ...
        <div className="flex flex-col my-12">
            ...
            <div className="flex flex-row items-center gap-4 my-8">
                <button
                    ...
                    ${weeks >= MIN_VALUE + 1 ? "bg-gray-400" : "bg-gray-300"}`}
...
export default function SetWeeks() {
    ...
    return (
        <main className="flex min-h-screen flex-col p-8 bg-[#f5f5f5]">
            <Link href="/planner/goal" className="flex flex-row items-center gap-2 w-20 mb-8 transition hover:scale-110 duration-300">
